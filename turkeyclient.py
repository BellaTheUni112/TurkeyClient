...
def show_splash(image_path, duration=3000):
    ...
    label = ctk.CTkLabel(splash, image=photo, text="")
    label.image = photo
    label.pack()
...
module_base = pymem.process.module_from_name(pm.process_handle, "GTAIV.exe").lpBaseOfDll
